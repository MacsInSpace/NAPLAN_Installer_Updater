...
| [`UninstallNaplanTask.cmd`](UninstallNaplanTask.cmd) | Runs `NukeScheduledTask.ps1` for easier removal of both task and application (useful for BYOD or manual uninstalls). |
||
